...
export const TOOL_RPC: Readonly<Record<string, readonly string[]>> = {
  mnemosyne_memory_query:      ['sdk.query'],
  mnemosyne_memory_ingest:     ['sdk.ingest'],
  mnemosyne_memory_forget:     ['sdk.forget'],
  mnemosyne_git_log:           ['sdk.git.log'],
  mnemosyne_resonance_list:    ['sdk.query'],
  mnemosyne_position_get:      ['sdk.query'],
  mnemosyne_position_update:   ['sdk.ingest'],
  mnemosyne_memory_ask:        ['sdk.ask'],
  mnemosyne_vault_list:        ['sdk.vaults.list'],
  mnemosyne_dream_bridges:     ['sdk.dream.bridges'],
  mnemosyne_spine_assignments: ['sdk.spine.assignments'],
  mnemosyne_voice_list:        ['sdk.voice.engines'],
  mnemosyne_voice_speak:       ['sdk.voice.speak'],
  mnemosyne_voice_status:      ['sdk.voice.status', 'sdk.voice.cancel'],
  mnemosyne_todo_add:          ['sdk.todo.add'],
  mnemosyne_todo_list:         ['sdk.todo.read'],
  mnemosyne_todo_update:       ['sdk.todo.read', 'sdk.todo.apply'],
  mnemosyne_todo_categories:   ['sdk.todo.read', 'sdk.todo.apply'],

// MODIFIED (Mnemosyne OS): was `from '@blocksuite/affine/model'`. Type-only, erased
// at runtime — see ./blocksuite-types.ts and the package NOTICE.md.
import type { ColumnDataType } from './blocksuite-types';

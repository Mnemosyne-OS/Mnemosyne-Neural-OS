...
[![Download Mnemosyne OS](https://img.shields.io/static/v1?label=Download&message=Mnemosyne+OS+%28v1.3.8-infinity%29+%C2%B7+NEW&color=111827&logo=github&style=for-the-badge)](https://github.com/Mnemosyne-OS/Mnemosyne-Neural-OS/releases/tag/v1.3.8-infinity)
...
### Shipped
- [x] 🚀 **Infinity Edition — 11 public releases**, now at [**v1.3.8 · The Second Channel**](https://github.com/Mnemosyne-OS/Mnemosyne-Neural-OS/releases/tag/v1.3.8-infinity)
